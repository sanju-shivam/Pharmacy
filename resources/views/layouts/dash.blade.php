...
<body>
        ...
        <section class="shadow">
            <div id="mySidenav" class="sidenav">
                ...
                <div class="links-list">
                    ...
                    @can('blogs', Blog::class)
                        <a href="/admin/blogs">Blogs</a>
                    @endcan

                    @can('user', User::class)
                        <a href="/admin/users">All Companies</a>
                    @endcan

                    @can('staff', Brand::class)
                        <a href="/admin/brands">All Brands</a>
                    @endcan
                    ...
                    @can('staff', Banner::class)
                        <a href="/admin/banners">All Banners</a>
                    @endcan
                    ...
                    <div>
                        ...
                        @can('categories', Category::class)
                            <a href="/admin/category">All Categories</a>
                        @endcan

                        @can('sales', Lead::class)
    ...
    <script type="text/javascript">
        ...
        $('#title').on('keyup', function() {
            var theTitle = this.value.toLowerCase().trim();
            linkInput = $('#link'),
            theLink = theTitle.replace(/&/g,'-and-')
            .replace(/[^a-z0-9]+/g,'-')
            .replace(/\-\-+/g,'-')
            .replace(/^-+|-+&/g,'');

            linkInput.val(theLink);
        });
    </script>
